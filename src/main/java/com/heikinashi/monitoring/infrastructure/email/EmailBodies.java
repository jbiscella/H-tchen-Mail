...
final class EmailBodies {
    ...
    // Legal disclaimer footer — appended to every HTML alert (see README §Disclaimer).
    private static final String DISCLAIMER_FOOTER =
            "<footer style=\"font-size:0.85em;color:#666;margin-top:2em;padding:1em;"
                    + "border-top:1px solid #ccc;\"><p><strong>Disclaimer:</strong> This is an "
                    + "automated alert based on historical price data and pattern detection "
                    + "&mdash; NOT financial advice. Past performance is not indicative of "
                    + "future results, and detected patterns do not account for all market "
                    + "conditions. Use at your own risk. Generated by the Heikin Ashi "
                    + "Monitoring Service, provided \"AS IS\" under its open-source license "
                    + "with no warranties.</p></footer>";
