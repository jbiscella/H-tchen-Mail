...
final class Keys {
    ...
    static final String STRATEGY_PENDING_ALERT_PK_PREFIX = "STRATEGY_PENDING_ALERT#";

    static final String SK_META = "META";
    static final String SK_CONFIG = "CONFIG";
    static final String SK_STRATEGY = "STRATEGY";
    ...
    static final String ENTITY_STRATEGY = "STRATEGY";
    static final String ENTITY_LOCK = "UNIQUE_LOCK";
    static final String ENTITY_PENDING_ALERT = "PENDING_ALERT";
    static final String ENTITY_STRATEGY_PENDING_ALERT = "STRATEGY_PENDING_ALERT";
    ...
    static final String GSI2_PK_RETRY_DUE_STRATEGY = "RETRY_DUE_STRATEGY";
    ...
    static String strategyPendingAlertPk(String eventUid) {
        return STRATEGY_PENDING_ALERT_PK_PREFIX + eventUid;
    }
